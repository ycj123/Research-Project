...
public class NodeAsHTMLPrinter extends VisitorAdapter
{
    ...
    public NodeAsHTMLPrinter(final PrintStream out, final String[] tokenNames) {
    ...
    private String quote(final String tokenName) {
    ...
    private String colour(final GroovySourceAST t) {
        final String black = "000000";
        final String blue = "17178B";
