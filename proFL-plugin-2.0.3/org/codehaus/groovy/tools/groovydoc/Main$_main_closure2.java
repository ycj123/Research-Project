...
class Main$_main_closure2 extends Closure implements GeneratedClosure
{
    ...
    public Main$_main_closure2(final Object _outerInstance, final Object _thisObject) {
        $getCallSiteArray();
    ...
    public Object doCall(final Object it) {
        ...
        return $getCallSiteArray()[0].callCurrent(this, ScriptBytecodeAdapter.createPojoWrapper(ScriptBytecodeAdapter.asType(((Reference<Object>)it2).get(), $get$$class$java$lang$String()), $get$$class$java$lang$String()));
    }
    ...
    private static /* synthetic */ CallSiteArray $createCallSiteArray() {
        ...
        return new CallSiteArray($get$$class$org$codehaus$groovy$tools$groovydoc$Main$_main_closure2(), names);
    }
    ...
    private static /* synthetic */ Class $get$$class$java$lang$String() {
        ...
        if (($class$java$lang$String = Main$_main_closure2.$class$java$lang$String) == null) {
            $class$java$lang$String = (Main$_main_closure2.$class$java$lang$String = class$("java.lang.String"));
        }
