...
package org.mudebug.prapr.reloc.commons.codec.language.bm;
...
public class Lang
{
    ...
    private static final String LANGUAGE_RULES_RN = "org/mudebug/prapr/reloc/commons/codec/language/bm/lang.txt";
    ...
    static {
        ...
        for (final NameType s : NameType.values()) {
            Lang.Langs.put(s, loadFromResource("org/mudebug/prapr/reloc/commons/codec/language/bm/lang.txt", Languages.getInstance(s)));
        }
    }
