...
public class HashCodeBuilder
{
    ...
    static void register(final Object value) {
        ...
        if (HashCodeBuilder.class$org$apache$commons$lang$builder$HashCodeBuilder == null) {
            class$org$apache$commons$lang$builder$HashCodeBuilder = (HashCodeBuilder.class$org$apache$commons$lang$builder$HashCodeBuilder = (class$ = class$("org.mudebug.prapr.reloc.commons.lang.builder.HashCodeBuilder")));
        }
        else {
