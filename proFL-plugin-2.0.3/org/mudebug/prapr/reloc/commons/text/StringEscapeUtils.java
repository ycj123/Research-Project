...
import org.mudebug.prapr.reloc.commons.text.translate.NumericEntityUnescaper;
import org.mudebug.prapr.reloc.commons.text.translate.UnicodeUnescaper;
import org.mudebug.prapr.reloc.commons.text.translate.OctalUnescaper;
import org.mudebug.prapr.reloc.commons.text.translate.CsvTranslators;
import org.mudebug.prapr.reloc.commons.text.translate.UnicodeUnpairedSurrogateRemover;
import org.mudebug.prapr.reloc.commons.text.translate.NumericEntityEscaper;
import org.mudebug.prapr.reloc.commons.text.translate.AggregateTranslator;
import org.mudebug.prapr.reloc.commons.text.translate.JavaUnicodeEscaper;
import org.mudebug.prapr.reloc.commons.text.translate.EntityArrays;
import org.mudebug.prapr.reloc.commons.text.translate.LookupTranslator;
import java.util.Map;
import java.util.Collections;
import java.util.HashMap;
import org.mudebug.prapr.reloc.commons.text.translate.CharSequenceTranslator;
...
public class StringEscapeUtils
{
    ...
    static {
        ...
        escapeJsonMap.put("\\", "\\\\");
        escapeJsonMap.put("/", "\\/");
        ESCAPE_JSON = new AggregateTranslator(new CharSequenceTranslator[] { new LookupTranslator(Collections.unmodifiableMap((Map<? extends CharSequence, ? extends CharSequence>)escapeJsonMap)), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE), JavaUnicodeEscaper.outsideOf(32, 127) });
        ...
        UNESCAPE_JSON = new AggregateTranslator(new CharSequenceTranslator[] { new OctalUnescaper(), new UnicodeUnescaper(), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_UNESCAPE) });
