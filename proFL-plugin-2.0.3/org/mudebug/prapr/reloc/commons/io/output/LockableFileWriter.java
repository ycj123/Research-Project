...
public class LockableFileWriter extends Writer
{
    ...
    public LockableFileWriter(File file, final String encoding, final boolean append, String lockDir) throws IOException {
    ...
    private Writer initWriter(final File file, final String encoding, final boolean append) throws IOException {
