...
public class LifecycleMappingsXpp3Reader
{
    ...
    private Execution parseExecution(final String tagName, final XmlPullParser parser, final boolean strict, final String encoding) throws IOException, XmlPullParserException {
    ...
    private Lifecycle parseLifecycle(final String tagName, final XmlPullParser parser, final boolean strict, final String encoding) throws IOException, XmlPullParserException {
    ...
    private LifecycleConfiguration parseLifecycleConfiguration(final String tagName, final XmlPullParser parser, final boolean strict, final String encoding) throws IOException, XmlPullParserException {
        final LifecycleConfiguration lifecycleConfiguration = new LifecycleConfiguration();
        ...
        while (eventType != 1) {
            if (eventType == 2) {
                if (parser.getName().equals(tagName)) {
                    ...
                    lifecycles.add(this.parseLifecycle("lifecycle", parser, strict, encoding));
                }
    ...
    private Phase parsePhase(final String tagName, final XmlPullParser parser, final boolean strict, final String encoding) throws IOException, XmlPullParserException {
    ...
    public LifecycleConfiguration read(final Reader reader, final boolean strict) throws IOException, XmlPullParserException {
    ...
    public LifecycleConfiguration read(final Reader reader) throws IOException, XmlPullParserException {
