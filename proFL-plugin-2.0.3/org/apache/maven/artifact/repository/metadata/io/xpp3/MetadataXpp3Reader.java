...
public class MetadataXpp3Reader
{
    ...
    private Metadata parseMetadata(final String tagName, final XmlPullParser parser, final boolean strict) throws IOException, XmlPullParserException {
        ...
        while (eventType != 1) {
            if (eventType == 2) {
                if (parser.getName().equals(tagName)) {
                    ...
                    else if (this.checkFieldWithDuplicate(parser, "versioning", null, parsed)) {
    ...
    private Plugin parsePlugin(final String tagName, final XmlPullParser parser, final boolean strict) throws IOException, XmlPullParserException {
        ...
        while (parser.nextTag() == 2) {
            ...
            else if (this.checkFieldWithDuplicate(parser, "prefix", null, parsed)) {
    ...
    private Snapshot parseSnapshot(final String tagName, final XmlPullParser parser, final boolean strict) throws IOException, XmlPullParserException {
        ...
        while (parser.nextTag() == 2) {
            ...
            else if (this.checkFieldWithDuplicate(parser, "buildNumber", null, parsed)) {
                snapshot.setBuildNumber(this.getIntegerValue(this.getTrimmedValue(parser.nextText()), "buildNumber", parser, strict));
            }
            else if (this.checkFieldWithDuplicate(parser, "localCopy", null, parsed)) {
    ...
    private Versioning parseVersioning(final String tagName, final XmlPullParser parser, final boolean strict) throws IOException, XmlPullParserException {
        ...
        while (parser.nextTag() == 2) {
            ...
            else if (this.checkFieldWithDuplicate(parser, "release", null, parsed)) {
                versioning.setRelease(this.getTrimmedValue(parser.nextText()));
            }
            else if (this.checkFieldWithDuplicate(parser, "snapshot", null, parsed)) {
                versioning.setSnapshot(this.parseSnapshot("snapshot", parser, strict));
            }
            else if (this.checkFieldWithDuplicate(parser, "versions", null, parsed)) {
            ...
            else if (this.checkFieldWithDuplicate(parser, "lastUpdated", null, parsed)) {
    ...
    public Metadata read(final Reader reader, final boolean strict) throws IOException, XmlPullParserException {
    ...
    public Metadata read(final Reader reader) throws IOException, XmlPullParserException {
        return this.read(reader, true);
    }
    
    public Metadata read(final InputStream in, final boolean strict) throws IOException, XmlPullParserException {
        final Reader reader = ReaderFactory.newXmlReader(in);
        return this.read(reader, strict);
    }
    
    public Metadata read(final InputStream in) throws IOException, XmlPullParserException {
        final Reader reader = ReaderFactory.newXmlReader(in);
