...
public class CvsDiffConsumer implements StreamConsumer
{
    ...
    public CvsDiffConsumer(final ScmLogger logger, final File workingDirectory) {
        ...
        if (line.startsWith("===")) {
            ...
            if (!line.startsWith("retrieving revision ")) {
                if (!line.startsWith("diff ")) {
                    if (line.startsWith("+") || line.startsWith("-") || line.startsWith(" ") || line.startsWith("@@") || line.equals("\\ No newline at end of file")) {
