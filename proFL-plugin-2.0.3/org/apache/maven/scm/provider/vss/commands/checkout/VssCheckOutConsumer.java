...
public class VssCheckOutConsumer extends AbstractConsumer implements StreamConsumer
{
    ...
    public VssCheckOutConsumer(final VssScmProviderRepository repo, final ScmLogger logger) {
        super(logger);
        this.currentPath = "";
