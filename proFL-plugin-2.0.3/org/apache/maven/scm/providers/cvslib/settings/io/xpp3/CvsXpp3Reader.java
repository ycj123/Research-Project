...
public class CvsXpp3Reader
{
    ...
    private Settings parseSettings(final XmlPullParser parser, final boolean strict) throws IOException, XmlPullParserException {
        ...
        while ((strict ? parser.nextTag() : this.nextTag(parser)) == 2) {
            ...
            else if (this.checkFieldWithDuplicate(parser, "useForceTag", null, parsed)) {
    ...
    private Settings read(final XmlPullParser parser, final boolean strict) throws IOException, XmlPullParserException {
        ...
        while (eventType != 1) {
            if (eventType == 2) {
                if (strict && !"cvs-settings".equals(parser.getName())) {
                    throw new XmlPullParserException("Expected root element 'cvs-settings' but found '" + parser.getName() + "'", parser, null);
                }
        ...
        throw new XmlPullParserException("Expected root element 'cvs-settings' but found no element at all: invalid XML document", parser, null);
    }
