...
public class VssXpp3Reader
{
    ...
    public boolean getBooleanValue(final String s, final String attribute, final XmlPullParser parser, final String defaultValue) throws XmlPullParserException {
    ...
    public Date getDateValue(final String s, final String attribute, final String dateFormat, final XmlPullParser parser) throws XmlPullParserException {
        if (s != null) {
            if (dateFormat == null) {
                return new Date(Long.valueOf(s));
            }
            final DateFormat dateParser = new SimpleDateFormat(dateFormat, Locale.US);
            try {
        ...
        while (eventType != 1) {
            if (eventType == 2) {
                if (parser.getName().equals(tagName)) {
                    ...
                    settings.setVssDirectory(this.getTrimmedValue(parser.nextText()));
                }
    ...
    public Settings read(final Reader reader, final boolean strict) throws IOException, XmlPullParserException {
        ...
        parser.next();
        return this.parseSettings("vss-settings", parser, strict);
    }
