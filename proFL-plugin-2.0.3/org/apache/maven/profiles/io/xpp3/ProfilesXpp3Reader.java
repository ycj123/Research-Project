...
public class ProfilesXpp3Reader
{
    ...
    private ProfilesRoot parseProfilesRoot(final String tagName, final XmlPullParser parser, final boolean strict) throws IOException, XmlPullParserException {
        final ProfilesRoot profilesRoot = new ProfilesRoot();
        final Set parsed = new HashSet();
    ...
    public ProfilesRoot read(final Reader reader, final boolean strict) throws IOException, XmlPullParserException {
        ...
        parser.next();
        return this.parseProfilesRoot("profilesXml", parser, strict);
    }
    
    public ProfilesRoot read(final Reader reader) throws IOException, XmlPullParserException {
        return this.read(reader, true);
    }
    
    public ProfilesRoot read(final InputStream in, final boolean strict) throws IOException, XmlPullParserException {
        final Reader reader = ReaderFactory.newXmlReader(in);
        return this.read(reader, strict);
    }
    
    public ProfilesRoot read(final InputStream in) throws IOException, XmlPullParserException {
        final Reader reader = ReaderFactory.newXmlReader(in);
