...
public abstract class Directive implements DirectiveConstants, Cloneable
{
    ...
    public abstract boolean render(final InternalContextAdapter p0, final Writer p1, final Node p2) throws IOException, ResourceNotFoundException, ParseErrorException, MethodInvocationException;
}
