...
public class CoverageResult
{
    ...
    public CoverageResult(final Description testUnitDescription, final int executionTime, final boolean greenSuite, final Collection<BlockLocation> visitedBlocks) {
