...
public class DefaultCodeHistory implements CodeHistory
{
    ...
    public DefaultCodeHistory(final CodeSource code, final HistoryStore historyStore) {
        this(code, historyStore.getHistoricResults(), historyStore.getHistoricClassPath());
    }
    
    public DefaultCodeHistory(final ClassInfoSource code, final Map<MutationIdentifier, MutationStatusTestPair> previousResults, final Map<ClassName, ClassHistory> previousClassPath) {
        this.code = code;
    ...
    @Override
    public Option<MutationStatusTestPair> getPreviousResult(final MutationIdentifier id) {
    ...
    @Override
    public boolean hasCoverageChanged(final ClassName className, final BigInteger currentCoverage) {
