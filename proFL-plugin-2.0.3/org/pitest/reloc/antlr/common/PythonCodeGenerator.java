...
import org.pitest.reloc.antlr.common.actions.python.CodeLexer;
import org.pitest.reloc.antlr.common.actions.python.ActionLexer;
...
public class PythonCodeGenerator extends CodeGenerator
{
    ...
    public void gen(final LexerGrammar grammar) throws IOException {
        ...
        if (this.grammar.superClass != null) {
            ...
            s = "org.pitest.reloc.antlr.common." + this.grammar.getSuperClass();
        }
    ...
    public String getASTCreateString(final Vector vector) {
        ...
        sb.append("org.pitest.reloc.antlr.common.make(");
        for (int i = 0; i < vector.size(); ++i) {
    ...
    private void setupGrammarParameters(final Grammar grammar) {
        if (grammar instanceof ParserGrammar) {
            ...
            this.exceptionThrown = "org.pitest.reloc.antlr.common.RecognitionException";
