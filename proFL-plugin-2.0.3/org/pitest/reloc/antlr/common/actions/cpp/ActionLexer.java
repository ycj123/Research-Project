...
package org.pitest.reloc.antlr.common.actions.cpp;
...
public class ActionLexer extends CharScanner implements ActionLexerTokenTypes, TokenStream
{
    ...
    protected final void mAST_ITEM(final boolean b) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (this.LA(1) == '#' && this.LA(2) == '(') {
            ...
            else if (text.equals("if") || text.equals("define") || text.equals("ifdef") || text.equals("ifndef") || text.equals("else") || text.equals("elif") || text.equals("endif") || text.equals("warning") || text.equals("error") || text.equals("ident") || text.equals("pragma") || text.equals("include")) {
                this.text.setLength(length);
    ...
    protected final void mTEXT_ITEM(final boolean b) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (this.LA(1) == '$' && this.LA(2) == 'F' && this.LA(3) == 'O') {
            ...
            final Token returnToken3 = this._returnToken;
            this.match(')');
            final String string = "text += " + returnToken3.getText();
            this.text.setLength(length);
            this.text.append(string);
        }
            ...
            if (this.LA(1) == 'T' && this.LA(2) == 'e') {
                ...
                this.match(')');
                final String string2 = "{ text.erase(_begin); text += " + returnToken4.getText() + "; }";
                this.text.setLength(length);
    ...
    protected final void mAST_CONSTRUCTOR(final boolean b) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        this.match(']');
        this.text.setLength(length10);
        String str = this.generator.processStringForASTConstructor(returnToken2.getText());
        if (returnToken != null) {
            str = str + "," + returnToken.getText();
        }
        this.text.setLength(length);
    ...
    protected final void mTEXT_ARG(final boolean b) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        int n2 = 0;
        while (ActionLexer._tokenSet_10.member(this.LA(1)) && this.LA(2) >= '\u0003' && this.LA(2) <= '\u00ff') {
            this.mTEXT_ARG_ELEMENT(false);
            if (ActionLexer._tokenSet_4.member(this.LA(1)) && ActionLexer._tokenSet_11.member(this.LA(2))) {
                this.mWS(false);
            }
            else if (!ActionLexer._tokenSet_11.member(this.LA(1))) {
                throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            }
            ++n2;
        }
    ...
    protected final void mTREE_ELEMENT(final boolean b) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        switch (this.LA(1)) {
            ...
            default: {
                ...
                if (this.LA(1) == '#' && ActionLexer._tokenSet_12.member(this.LA(2))) {
                    final int length4 = this.text.length();
                    this.match('#');
                    this.text.setLength(length4);
        ...
        switch (this.LA(1)) {
            ...
            case '<': {
                switch (this.LA(1)) {
                    case '<': {
                        this.match('<');
                        while (ActionLexer._tokenSet_14.member(this.LA(1))) {
                            this.matchNot('>');
                        }
                        this.match('>');
                        break;
            ...
            default: {
                if (this.LA(1) == '-' && this.LA(2) == '>' && ActionLexer._tokenSet_12.member(this.LA(3))) {
                    this.match("->");
                    this.mID_ELEMENT(false);
                    break;
                }
    ...
    protected final void mTEXT_ARG_ID_ELEMENT(final boolean b) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        switch (this.LA(1)) {
            ...
            default: {
                ...
                if (ActionLexer._tokenSet_11.member(this.LA(1))) {
                    break;
                }
                throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            }
    ...
    private static final long[] mk_tokenSet_3() {
        return new long[] { 288230380446688768L, 576460745995190270L, 0L, 0L, 0L };
    }
    ...
    private static final long[] mk_tokenSet_6() {
        return new long[] { 576189812881499648L, 576460745995190270L, 0L, 0L, 0L };
    }
    ...
    private static final long[] mk_tokenSet_9() {
        return new long[] { 576179277326712832L, 576460745995190270L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_10() {
        return new long[] { 576188709074894848L, 576460745995190270L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_11() {
        return new long[] { 576208504579171840L, 576460746532061182L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_12() {
        return new long[] { 288230376151711744L, 576460745995190270L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_13() {
        return new long[] { 3747275269732312576L, 671088640L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_14() {
        final long[] array = new long[8];
        array[0] = -4611686018427387912L;
        for (int i = 1; i <= 3; ++i) {
            array[i] = -1L;
        }
        return array;
    ...
    private static final long[] mk_tokenSet_15() {
        return new long[] { 576183181451994624L, 576460746129407998L, 0L, 0L, 0L };
    }
    ...
    private static final long[] mk_tokenSet_19() {
        return new long[] { 288231527202947072L, 576460746129407998L, 0L, 0L, 0L };
    }
    ...
    private static final long[] mk_tokenSet_21() {
        return new long[] { 576370098428716544L, 576460746129407998L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_22() {
        return new long[] { 576315157207066112L, 576460746666278910L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_23() {
        return new long[] { 576190912393127424L, 576460745995190270L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_24() {
        return new long[] { 576188713369871872L, 576460745995190270L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_25() {
        return new long[] { 576459193230304768L, 576460746532061182L, 0L, 0L, 0L };
    }
    
    private static final long[] mk_tokenSet_26() {
        return new long[] { 576388824486127104L, 576460746532061182L, 0L, 0L, 0L };
    }
