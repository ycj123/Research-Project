...
public class LLkDebuggingParser extends LLkParser implements DebuggingParser
{
    ...
    protected void setupDebugging(final TokenStream tokenStream, final TokenBuffer tokenBuffer) {
        ...
        try {
            ...
            Utils.loadClass("org.pitest.reloc.antlr.common.parseview.ParseView").getConstructor(LLkDebuggingParser.class, TokenStream.class, TokenBuffer.class).newInstance(this, tokenStream, tokenBuffer);
        }
        catch (Exception obj) {
