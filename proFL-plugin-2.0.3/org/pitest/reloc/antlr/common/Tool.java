...
public class Tool
{
    ...
    public int doEverything(final String[] array) {
        final org.pitest.reloc.antlr.common.preprocessor.Tool tool = new org.pitest.reloc.antlr.common.preprocessor.Tool(this, array);
        ...
        try {
            ...
            final String string = "org.pitest.reloc.antlr.common." + this.getLanguage(behavior) + "CodeGenerator";
            try {
