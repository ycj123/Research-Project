...
import org.pitest.reloc.asm.signature.SignatureWriter;
import org.pitest.reloc.asm.signature.SignatureReader;
...
public abstract class Remapper
{
    ...
    public String mapPackageName(final String name) {
        final String fakeName = this.map(name + ".FakeClassName");
        final int index;
