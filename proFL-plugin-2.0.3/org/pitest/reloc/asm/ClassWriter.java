...
public class ClassWriter extends ClassVisitor
{
    ...
    public final ModuleVisitor visitModule(final String name, final int access, final String version) {
        return this.moduleWriter = new ModuleWriter(this, this.newModule(name), access, (version == null) ? 0 : this.newUTF8(version));
    }
    ...
    public final void visitInnerClass(final String name, final String outerName, final String innerName, final int access) {
        ...
        final Item nameItem = this.newStringishItem(7, name);
    ...
    public int newClass(final String value) {
        return this.newStringishItem(7, value).index;
    }
    
    public int newMethodType(final String methodDesc) {
        return this.newStringishItem(16, methodDesc).index;
    }
    
    public int newModule(final String moduleName) {
        return this.newStringishItem(19, moduleName).index;
    }
    
    public int newPackage(final String packageName) {
        return this.newStringishItem(20, packageName).index;
    }
    ...
    static {
        final byte[] b = new byte[221];
        final String s = "AAAAAAAAAAAAAAAABCLMMDDDDDEEEEEEEEEEEEEEEEEEEEAAAAAAAADDDDDEEEEEEEEEEEEEEEEEEEEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAANAAAAAAAAAAAAAAAAAAAAJJJJJJJJJJJJJJJJDOPAAAAAAGGGGGGGHIFBFAAFFAARQJJKKSSSSSSSSSSSSSSSSSST";
