...
public final class HierarchicalClassId implements Serializable
{
    ...
    public HierarchicalClassId(final ClassIdentifier classId, final String hierarchicalHash) {
    ...
    public HierarchicalClassId(final long hash, final ClassName name, final String hierarchicalHash) {
