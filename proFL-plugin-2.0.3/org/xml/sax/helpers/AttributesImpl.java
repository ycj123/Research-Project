...
public class AttributesImpl implements Attributes
{
    ...
    public int getIndex(final String anObject, final String anObject2) {
        for (int n = this.length * 5, i = 0; i < n; i += 5) {
            if (this.data[i].equals(anObject) && this.data[i + 1].equals(anObject2)) {
                return i / 5;
            }
        }
        return -1;
    ...
    public int getIndex(final String anObject) {
        for (int n = this.length * 5, i = 0; i < n; i += 5) {
            if (this.data[i + 2].equals(anObject)) {
                return i / 5;
            }
        }
        return -1;
    ...
    private void badIndex(final int i) throws ArrayIndexOutOfBoundsException {
