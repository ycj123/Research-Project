...
public class ASMifier extends Printer
{
    ...
    public Printer visitModule(final String name, final int flags, final String version) {
        this.buf.setLength(0);
        this.buf.append("ModuleVisitor mdv = cw.visitModule(");
        this.appendConstant(name);
        this.buf.append(", ");
        this.appendAccess(flags | 0x200000);
        this.buf.append(", ");
        this.appendConstant(version);
        this.buf.append(");\n\n");
        this.text.add(this.buf.toString());
        final ASMifier a = this.createASMifier("mdv", 0);
    ...
    public void visitMainClass(final String mainClass) {
        this.buf.setLength(0);
        this.buf.append("mdv.visitMainClass(");
        appendConstant(this.buf, mainClass);
        this.buf.append(");\n");
        this.text.add(this.buf.toString());
    }
    ...
    public void visitPackage(final String packaze) {
        this.buf.setLength(0);
        this.buf.append("mdv.visitPackage(");
        appendConstant(this.buf, packaze);
        this.buf.append(");\n");
        this.text.add(this.buf.toString());
    }
    ...
    public void visitRequire(final String module, final int access, final String version) {
        this.buf.setLength(0);
        this.buf.append("mdv.visitRequire(");
        appendConstant(this.buf, module);
        this.buf.append(", ");
        this.appendAccess(access | 0x200000);
        this.buf.append(", ");
        appendConstant(this.buf, version);
        this.buf.append(");\n");
        this.text.add(this.buf.toString());
    }
    ...
    public void visitExport(final String packaze, final int access, final String... modules) {
        this.buf.setLength(0);
        this.buf.append("mdv.visitExport(");
        appendConstant(this.buf, packaze);
        this.buf.append(", ");
        this.appendAccess(access | 0x200000);
    ...
    public void visitUse(final String service) {
        this.buf.setLength(0);
        this.buf.append("mdv.visitUse(");
        appendConstant(this.buf, service);
        this.buf.append(");\n");
        this.text.add(this.buf.toString());
    }
    ...
    public void visitProvide(final String service, final String... providers) {
        this.buf.setLength(0);
        this.buf.append("mdv.visitProvide(");
        appendConstant(this.buf, service);
        this.buf.append(",  new String[] {");
    ...
    protected ASMifier createASMifier(final String name, final int id) {
        return new ASMifier(393216, name, id);
    }
    ...
    void appendAccess(final int access) {
        ...
        if ((access & 0x10) != 0x0) {
            ...
            if ((access & 0x200000) == 0x0) {
                this.buf.append("ACC_FINAL");
            }
            else {
                this.buf.append("ACC_TRANSITIVE");
            }
            first = false;
        }
        if ((access & 0x8) != 0x0) {
        ...
        if ((access & 0x40) != 0x0) {
            ...
            if ((access & 0x80000) == 0x0) {
                if ((access & 0x200000) == 0x0) {
                    ...
                    this.buf.append("ACC_STATIC_PHASE");
                }
            }
            else {
