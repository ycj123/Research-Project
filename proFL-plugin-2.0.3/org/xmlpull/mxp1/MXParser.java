...
public class MXParser implements XmlPullParser
{
        ...
        while (true) {
            ...
            if (!this.isNameChar(ch)) {
                ...
                if (this.processNamespaces) {
                    ...
                    for (int j = 1; j < this.attributeCount; ++j) {
                        for (int k = 0; k < j; ++k) {
                            if (this.attributeUri[k] == this.attributeUri[j] && ((this.allStringsInterned && this.attributeName[k].equals(this.attributeName[j])) || (!this.allStringsInterned && this.attributeNameHash[k] == this.attributeNameHash[j] && this.attributeName[k].equals(this.attributeName[j])))) {
                                String attr1 = this.attributeName[k];
                                if (this.attributeUri[k] != null) {
                                    attr1 = this.attributeUri[k] + ":" + attr1;
                                }
                                String attr2 = this.attributeName[j];
                                if (this.attributeUri[j] != null) {
                                    attr2 = this.attributeUri[j] + ":" + attr2;
                                }
                    ...
                    for (int l = 1; l < this.attributeCount; ++l) {
                        for (int m = 0; m < l; ++m) {
                            if ((this.allStringsInterned && this.attributeName[m].equals(this.attributeName[l])) || (!this.allStringsInterned && this.attributeNameHash[m] == this.attributeNameHash[l] && this.attributeName[m].equals(this.attributeName[l]))) {
                                final String attr3 = this.attributeName[m];
                                final String attr4 = this.attributeName[l];
    ...
    static {
        ...
        NCODING = new char[] { 'n', 'c', 'o', 'd', 'i', 'n', 'g' };
        TANDALONE = new char[] { 't', 'a', 'n', 'd', 'a', 'l', 'o', 'n', 'e' };
        YES = new char[] { 'y', 'e', 's' };
        NO = new char[] { 'n', 'o' };
        ...
        for (char ch3 = '\u00c0'; ch3 <= '\u02ff'; ++ch3) {
            setNameStart(ch3);
        }
        for (char ch4 = '\u0370'; ch4 <= '\u037d'; ++ch4) {
            setNameStart(ch4);
        }
        for (char ch5 = '\u037f'; ch5 < '\u0400'; ++ch5) {
            setNameStart(ch5);
        }
        setName('-');
        setName('.');
        for (char ch6 = '0'; ch6 <= '9'; ++ch6) {
            setName(ch6);
        }
        setName('·');
        for (char ch7 = '\u0300'; ch7 <= '\u036f'; ++ch7) {
            setName(ch7);
        }
    }
}
