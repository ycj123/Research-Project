...
class AstBrowser$_run_closure3_closure9_closure20 extends Closure implements GeneratedClosure
{
    ...
    public AstBrowser$_run_closure3_closure9_closure20(final Object _outerInstance, final Object _thisObject, final Reference<Object> phasePicker, final Reference<Object> script) {
    ...
    private static /* synthetic */ CallSiteArray $createCallSiteArray() {
        ...
        return new CallSiteArray($get$$class$groovy$inspect$swingui$AstBrowser$_run_closure3_closure9_closure20(), names);
    }
    
    private static /* synthetic */ CallSite[] $getCallSiteArray() {
        CallSiteArray $createCallSiteArray;
        if (AstBrowser$_run_closure3_closure9_closure20.$callSiteArray == null || ($createCallSiteArray = AstBrowser$_run_closure3_closure9_closure20.$callSiteArray.get()) == null) {
            $createCallSiteArray = $createCallSiteArray();
            AstBrowser$_run_closure3_closure9_closure20.$callSiteArray = new SoftReference($createCallSiteArray);
        }
    ...
    private static /* synthetic */ Class $get$$class$java$lang$Object() {
        ...
        if (($class$java$lang$Object = AstBrowser$_run_closure3_closure9_closure20.$class$java$lang$Object) == null) {
            $class$java$lang$Object = (AstBrowser$_run_closure3_closure9_closure20.$class$java$lang$Object = class$("java.lang.Object"));
        }
    ...
    private static /* synthetic */ Class $get$$class$groovy$lang$Closure() {
        ...
        if (($class$groovy$lang$Closure = AstBrowser$_run_closure3_closure9_closure20.$class$groovy$lang$Closure) == null) {
            $class$groovy$lang$Closure = (AstBrowser$_run_closure3_closure9_closure20.$class$groovy$lang$Closure = class$("groovy.lang.Closure"));
        }
