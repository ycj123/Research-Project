...
class BasicMenuBar$_run_closure1_closure4 extends Closure implements GeneratedClosure
{
    private static /* synthetic */ SoftReference $callSiteArray;
    private static /* synthetic */ Class $class$java$lang$Object;
    
    public BasicMenuBar$_run_closure1_closure4(final Object _outerInstance, final Object _thisObject) {
        $getCallSiteArray();
    ...
    public Object doCall(final Object it) {
        ...
        $getCallSiteArray[3].callCurrent(this, $getCallSiteArray[4].callGroovyObjectGetProperty(this));
    ...
    private static /* synthetic */ CallSiteArray $createCallSiteArray() {
        ...
        return new CallSiteArray($get$$class$groovy$ui$view$BasicMenuBar$_run_closure1_closure4(), names);
    }
    
    private static /* synthetic */ CallSite[] $getCallSiteArray() {
        CallSiteArray $createCallSiteArray;
        if (BasicMenuBar$_run_closure1_closure4.$callSiteArray == null || ($createCallSiteArray = BasicMenuBar$_run_closure1_closure4.$callSiteArray.get()) == null) {
            $createCallSiteArray = $createCallSiteArray();
            BasicMenuBar$_run_closure1_closure4.$callSiteArray = new SoftReference($createCallSiteArray);
        }
    ...
    private static /* synthetic */ Class $get$$class$java$lang$Object() {
        ...
        if (($class$java$lang$Object = BasicMenuBar$_run_closure1_closure4.$class$java$lang$Object) == null) {
            $class$java$lang$Object = (BasicMenuBar$_run_closure1_closure4.$class$java$lang$Object = class$("java.lang.Object"));
        }
