...
class BasicMenuBar$_run_closure1_closure6 extends Closure implements GeneratedClosure
{
    private static /* synthetic */ SoftReference $callSiteArray;
    private static /* synthetic */ Class $class$java$lang$Object;
    
    public BasicMenuBar$_run_closure1_closure6(final Object _outerInstance, final Object _thisObject) {
        $getCallSiteArray();
    ...
    public Object doCall(final Object it) {
        ...
        $getCallSiteArray[6].callCurrent(this, $getCallSiteArray[7].callGroovyObjectGetProperty(this));
        ...
        return $getCallSiteArray[20].callCurrent(this, $getCallSiteArray[21].callGroovyObjectGetProperty(this));
    }
    ...
    private static /* synthetic */ CallSiteArray $createCallSiteArray() {
        ...
        return new CallSiteArray($get$$class$groovy$ui$view$BasicMenuBar$_run_closure1_closure6(), names);
    }
    
    private static /* synthetic */ CallSite[] $getCallSiteArray() {
        CallSiteArray $createCallSiteArray;
        if (BasicMenuBar$_run_closure1_closure6.$callSiteArray == null || ($createCallSiteArray = BasicMenuBar$_run_closure1_closure6.$callSiteArray.get()) == null) {
            $createCallSiteArray = $createCallSiteArray();
            BasicMenuBar$_run_closure1_closure6.$callSiteArray = new SoftReference($createCallSiteArray);
        }
    ...
    private static /* synthetic */ Class $get$$class$java$lang$Object() {
        ...
        if (($class$java$lang$Object = BasicMenuBar$_run_closure1_closure6.$class$java$lang$Object) == null) {
            $class$java$lang$Object = (BasicMenuBar$_run_closure1_closure6.$class$java$lang$Object = class$("java.lang.Object"));
        }
