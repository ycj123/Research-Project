...
class StreamingSAXBuilder$_closure2_closure7_closure8 extends Closure implements GeneratedClosure
{
    private Reference<Object> buf;
    private static /* synthetic */ SoftReference $callSiteArray;
    
    public StreamingSAXBuilder$_closure2_closure7_closure8(final Object _outerInstance, final Object _thisObject, final Reference<Object> buf) {
        $getCallSiteArray();
    ...
    private static /* synthetic */ CallSiteArray $createCallSiteArray() {
        ...
        return new CallSiteArray($get$$class$groovy$xml$StreamingSAXBuilder$_closure2_closure7_closure8(), names);
    }
    
    private static /* synthetic */ CallSite[] $getCallSiteArray() {
        CallSiteArray $createCallSiteArray;
        if (StreamingSAXBuilder$_closure2_closure7_closure8.$callSiteArray == null || ($createCallSiteArray = StreamingSAXBuilder$_closure2_closure7_closure8.$callSiteArray.get()) == null) {
            $createCallSiteArray = $createCallSiteArray();
            StreamingSAXBuilder$_closure2_closure7_closure8.$callSiteArray = new SoftReference($createCallSiteArray);
        }
