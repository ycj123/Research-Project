...
class StreamingDOMBuilder$_closure4_closure14 extends Closure implements GeneratedClosure
{
    private Reference<Object> namespaces;
    private static /* synthetic */ SoftReference $callSiteArray;
    
    public StreamingDOMBuilder$_closure4_closure14(final Object _outerInstance, final Object _thisObject, final Reference<Object> namespaces) {
        $getCallSiteArray();
    ...
    private static /* synthetic */ CallSiteArray $createCallSiteArray() {
        ...
        return new CallSiteArray($get$$class$groovy$xml$StreamingDOMBuilder$_closure4_closure14(), names);
    }
    
    private static /* synthetic */ CallSite[] $getCallSiteArray() {
        CallSiteArray $createCallSiteArray;
        if (StreamingDOMBuilder$_closure4_closure14.$callSiteArray == null || ($createCallSiteArray = StreamingDOMBuilder$_closure4_closure14.$callSiteArray.get()) == null) {
            $createCallSiteArray = $createCallSiteArray();
            StreamingDOMBuilder$_closure4_closure14.$callSiteArray = new SoftReference($createCallSiteArray);
        }
